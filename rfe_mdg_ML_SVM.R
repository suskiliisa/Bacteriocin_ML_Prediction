...
##--- Importing rfe-mdg-rf feature sets ====

## WITH RFE-MDG SELECTED FEATURES
...
svmGrid <- expand.grid(sigma = seq(0.1, 1, 0.1), C = 2^(2:7))
...
plot(varImp(new_tmodel2), main="Variable Importance with xyz")

# predictions for TRAINING data
svm_preds_train <- predict(new_tmodel2, train, type = "raw") 
...
write.csv(probabilities_test, file = "/path/ML_results/rfe_mdgsfs_probability_test_SVM.csv", row.names = FALSE)
